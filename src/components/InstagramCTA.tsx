...
export const INSTAGRAM_URL =
  "https://www.instagram.com/pahadi__keeda";

export function InstagramCTA() {
  return (
    <section className="border-t border-hero-foreground/10 bg-primary py-16 text-primary-foreground sm:py-20">
