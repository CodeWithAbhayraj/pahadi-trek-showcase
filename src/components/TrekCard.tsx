  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-card border border-border bg-card shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-card-hover">
      <div className="relative aspect-[4/3] overflow-hidden bg-muted">
        <img
          src={trek.image}
          alt={`${trek.name} trekking landscape`}
          width={1400}
          height={1050}
          loading="lazy"
        ...
        <span className="absolute left-4 top-4 rounded-full bg-background/90 px-3 py-1 text-xs font-bold text-primary backdrop-blur-sm">
          {trek.difficulty}
        </span>
      </div>
